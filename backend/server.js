...
const ROUTE_META = {
  '/': { title: 'つながるくまもと｜熊本地震 被災者支援・安否確認・物資マッチングアプリ', description: '熊本地震の被災者支援アプリ「つながるくまもと」。物資の譲渡・募集、安否確認、迷子動物の捜索、熊本地震関連の最新ニュースを一つのアプリで。' },
  ...
  '/pets': { title: '動物を探す｜つながるくまもと', description: 'はぐれてしまった動物の捜索・目撃情報共有掲示板。' },
  ...
  '/mizu': { title: 'きょうの給水・断水情報｜つながるくまもと', description: '給水所・断水の状況・炊き出し・災害時協力井戸・災害ボランティアの最新情報を市町村の公式発表からまとめています。' },
  '/gasoline': { title: 'ガソリンスタンドを探す｜つながるくまもと', description: '資源エネルギー庁の検索システムに「営業可」と報告された熊本県内のガソリンスタンドを地域別に確認できます。' },
  '/notices': { title: '給水・り災証明などのお知らせ｜つながるくまもと', description: '地震情報・り災証明の受付状況など、市町村の公式発表からまとめた最新のお知らせを確認できます。' },
};
